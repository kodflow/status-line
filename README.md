...
| MCP | One pill: enabled servers sorted, disabled ones crossed out after them. Sources: managed, `--mcp-config` of the running session (Linux), local, project, user, enabled plugins |
